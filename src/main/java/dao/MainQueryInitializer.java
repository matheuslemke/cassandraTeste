...
public class MainQueryInitializer
{
	...
	public void initializeMainQuery()
	{
		...
		long idInfoComplementar, idFlagTipoPessoa = 0;
		int i = -1, cidadesNulas = 0, paisesNulos = 0, enderecosNulos = 0, ufNulas = 0, localidadesNulas = 0,
				logradourosNulos = 0, infoComplNulas = 0, pessoasFisicasNulas = 0;
				...
				if (parceiro != null)
				{
					...
					if (endereco != null)
					{
						...
						if (logradouro != null)
						{
							...
							System.out.println(queryCidade);
							cidade = getUniqueRow(queryCidade, "CIDADE");
							if (cidade != null)
							{
								...
								if (unidadeFederativa != null)
								{
									...
									if (pais != null)
									{
										...
										{
											System.out.println("Mais uma localidade Nula");
											localidadesNulas++;
										}
									} else
									{
